...
**FancyNpcs** is a soft dependency — it's only pulled in when you actually use
NPC features and the display module opts to download it on demand. Plain
server-selector sign use doesn't require FancyNpcs.
