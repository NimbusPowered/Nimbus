...
**`META-INF/services/dev.nimbuspowered.nimbus.module.NimbusModule`** — ServiceLoader descriptor pointing to your implementation class:

```text title="META-INF/services/dev.nimbuspowered.nimbus.module.NimbusModule"
...
**`src/main/resources/META-INF/services/dev.nimbuspowered.nimbus.module.NimbusModule`**
```text title="META-INF/services/dev.nimbuspowered.nimbus.module.NimbusModule"
...
└── src/main/
    ...
    └── resources/
        ├── module.properties
        └── META-INF/services/
            └── dev.nimbuspowered.nimbus.module.NimbusModule
```
