...
- **Drittanbieter-Module:** Die bisherigen Imports funktionieren dank Deprecated-Typealiases weiterhin, lösen aber Compiler-Warnungen aus. Bitte alle Imports der Form `dev.nimbuspowered.nimbus.module.<Typ>` auf `dev.nimbuspowered.nimbus.module.api.<Typ>` umstellen. Die Kompatibilitäts-Shim wird in 0.14.0 entfernt.
