...
What's actively being worked on or is next in the queue.

### Stabilize for Real-World Use (v0.9.x)

The core engine, cluster system, and module framework are feature-complete for most use cases. The current focus is making everything rock-solid under real operator workloads.
...
| Version | Date | Theme |
|---------|------|-------|
| **v0.8.1** | April 13, 2026 | 15 production-critical fixes + cluster TLS keystore bug |
| **v0.8.0** | April 12, 2026 | Production readiness audit — 65 findings resolved across security, stability, and performance |
