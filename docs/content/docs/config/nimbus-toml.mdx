...
<Callout type="info">
Metrics are exposed via `GET /api/metrics` (Prometheus format). See [API Reference](/docs/reference/api) for scrape configuration.
</Callout>
