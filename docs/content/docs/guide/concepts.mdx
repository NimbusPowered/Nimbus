...
<Terminal title="nimbus">{`<span class="t-dim">[12:00:01]</span> <span class="t-cyan">ℹ</span> Detected Java installations: Java 17, Java 21
...
<span class="t-dim">[12:00:12]</span> <span class="t-green">✓</span> Java 16 installed to jdks/java-16/bin/java`}</Terminal>
