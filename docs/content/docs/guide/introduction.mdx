...
<Terminal title="nimbus">{`<span class="t-blue">   _  __ __ _   __ ___  _ __  ___</span>
<span class="t-bright-blue">  / |/ // // \,' // o.)/// /,' _/</span>
<span class="t-cyan"> / || // // \,' // o \/ U /_\ \`. </span>
<span class="t-bright-cyan">/_/|_//_//_/ /_//___,'\_,'/___,'</span>
<span class="t-dim">            C L O U D</span>`}</Terminal>

<Terminal title="nimbus — in action">{`<span class="t-dim">[12:00:01]</span> <span class="t-yellow">▲ STARTING</span>  <span class="t-bold">Proxy-1</span> <span class="t-dim">(group=Proxy, port=25565)</span>
...
<span class="t-dim">4 service(s)</span>`}</Terminal>
...
<Terminal title="nimbus — architecture">{`<span class="t-cyan t-bold">┌─────────────────────────────────────┐</span>
...
<span class="t-cyan t-bold">│</span>  <span class="t-green">└─────────┘</span> <span class="t-green">└───────┘</span> <span class="t-green">└────────┘</span> <span class="t-cyan t-bold">│</span>
<span class="t-cyan t-bold">└─────────────────────────────────────┘</span>`}</Terminal>
