...
- **Web Dashboard** (BETA) — Browser-based management UI at [dashboard.nimbuspowered.org](https://dashboard.nimbuspowered.org). Service overview, real-time console, plugin management, stress testing, and more — all from your browser.
...
| **nimbus-sdk** | Backend server plugin (Spigot 1.8.8+ / Paper / Folia compatible) that connects game servers to the Nimbus API. Auto-deployed to all backend instances. |
...
Want a visual interface? Try the [Web Dashboard](/docs/guide/dashboard) (BETA) at [dashboard.nimbuspowered.org](https://dashboard.nimbuspowered.org).
