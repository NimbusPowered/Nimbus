...
<Terminal title="nimbus — multi-node cluster">{`<span class="t-dim">                        Players</span>
...
<span class="t-green t-bold">         └────────────┘</span>    <span class="t-green t-bold">└─────────────┘</span>`}</Terminal>
...
<Terminal title="terminal — worker node">{`<span class="t-dim">$</span> curl -fsSL https://raw.githubusercontent.com/kryonixmc/Nimbus/main/install-agent.sh | bash`}</Terminal>

**Windows (PowerShell):**

<Terminal title="powershell — worker node">{`<span class="t-dim">&gt;</span> irm https://raw.githubusercontent.com/kryonixmc/Nimbus/main/install-agent.ps1 | iex`}</Terminal>
...
<Terminal title="nimbus">{`<span class="t-prompt">nimbus</span> <span class="t-cyan">»</span> nodes
...
<span class="t-dim">2/2 online</span>`}</Terminal>
...
<Terminal title="nimbus">{`<span class="t-prompt">nimbus</span> <span class="t-cyan">»</span> lb
...
<span class="t-bold">Proxy-2</span>       10.0.0.3      30000   44        <span class="t-green">● READY</span>`}</Terminal>
