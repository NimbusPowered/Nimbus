...
/** Baseline migration: core tables (ServiceEvents, ScalingEvents). */
object V1_Baseline : Migration {
    override val version = 1
    override val description = "Core tables: service_events, scaling_events"
    override val baseline = true

    override fun Transaction.migrate() {
        SchemaUtils.createMissingTablesAndColumns(ServiceEvents, ScalingEvents)
    }
}
